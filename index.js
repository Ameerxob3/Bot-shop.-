...
let owners = '1103011911320211507'//ايدي الي هيتحول له الكريديت
let owner;
const
  updateAdmins = () => {
    owner = db.get("admins")
    owners = '1103011911320211507'//ايدي الي هيتحول له الكريديت
    owner.unshift('1103011911320211507')//اي دي حقك
  }
updateAdmins()
...
client.on("ready", () => {
 ...
 client.on('guildCreate', guild => {
  ...
  let textList = [`${prefix}Stock`, `${prefix}help`, ]
